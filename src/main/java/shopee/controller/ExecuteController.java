...
public class ExecuteController extends magic.controller.ExecuteController {
	...
	@Override
	public SlackMessage execute( @ApiParam( value = "Bean名稱", allowableValues = "buyMiJiaTask,seleniumTask", required = true ) @PathVariable String name, @ApiParam( hidden = true ) String text ) {
